...
public class Interface extends JFrame {
  ...
  //mes  vars
			...
			public void run() {
				try {
					...
					try {
						...
						ProfileImpl pr=new ProfileImpl(p);
						AgentContainer c=r.createMainContainer(pr);
						AgentController central=c.createNewAgent("Central","Partie2.AgentC",null);
						central.start();*/
	...
	public Interface() {
		...
		ListProduit.setModel(new DefaultComboBoxModel(new String[] {"Clavier", "Ecran", "Souris"}));
		...
		btnAjouterAch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//int nbrAch =Integer.parseInt(nbrAchT.getText());
		...
		btnLancerEnch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			   ...
			   int j=1;
				try {
					//TextArea textArea = new TextArea();
					//textArea.setBounds(21, 264, 522, 111);
				    //	panel.add(textArea);
					 for(Acheteur A:ListeAcheteurs) {
							System.out.println("liste achteur .."+ListeAcheteurs.get(j-1).PrixMax);
							System.out.println("liste achteur .."+ListeAcheteurs.get(j-1).Mise);
							j++;
						}
			        ...
			        for(int i=1; i<=nbrAch;i++) {
			        	...
			        	arg1[0]=ListeAcheteurs.get(i-1).PrixMax; arg1[1]=ListeAcheteurs.get(i-1).Mise;  
			           	//System.out.println("lidfhhf prixmax"+arg1[0]); 	
			        	//System.out.println("lidfhhf mise"+arg1[1]);
